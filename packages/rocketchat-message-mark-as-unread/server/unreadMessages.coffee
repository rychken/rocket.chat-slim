Meteor.methods
	unreadMessages: (firstUnreadMessage) ->
		...
		originalMessage = Sequoia.models.Messages.findOneById firstUnreadMessage._id, {fields: {u: 1, rid: 1, file: 1, ts: 1}}
		...
		lastSeen = Sequoia.models.Subscriptions.findOneByRoomIdAndUserId(originalMessage.rid, Meteor.userId()).ls
		...
		Sequoia.models.Subscriptions.setAsUnreadByRoomIdAndUserId(originalMessage.rid, Meteor.userId(), originalMessage.ts)
