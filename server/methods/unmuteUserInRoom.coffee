Meteor.methods
	unmuteUserInRoom: (data) ->
		...
		unmutedUser = Sequoia.models.Users.findOneByUsername data.username

		Sequoia.models.Rooms.unmuteUsernameByRoomId data.rid, unmutedUser.username

		fromUser = Sequoia.models.Users.findOneById fromId
		Sequoia.models.Messages.createUserUnmutedWithRoomIdAndUser data.rid, unmutedUser,
			u:
				_id: fromUser._id
